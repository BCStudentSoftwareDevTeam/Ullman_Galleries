...
def load_forms_data():
    Forms(fid=1, first_name="John", last_name="Backus", street_address="101 Road",second_address = "Blue", city="Fortran", state="KY", email="John@Backus.me",phone_number="1234567890", website="Backus.me", gallery=1, cv=1, personal_statement=9, zip_code = "40404", submit_date = "2018-01-12 12:00:00").save(force_insert=True)

    Forms(fid=2, first_name="Rob", last_name="Pike", street_address="101 Pike Road", second_address = "Red", city="Golang", state="NY", email="Rob@Pike.go",phone_number="0987654321", website="Pike.go", gallery=2, cv=10, personal_statement=18, zip_code = "60819", submit_date = "2018-01-12 12:00:00").save(force_insert=True)
